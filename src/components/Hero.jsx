...
const Hero = () => {
  return (
    <div className=" bg-[#F2F0F1] overflow-hidden">
      <div className="mx-auto max-w-6xl py-10  px-4 grid grid-cols-1 lg:grid-cols-2 items-center">
        {/* Text Content */}
        <div className="animate-bounce [animation-iteration-count:2]">
          ...
          {/* Stats */}
          <div className="flex flex-wrap gap-8 pt-6 justify-center md:justify-start">
            <div>
